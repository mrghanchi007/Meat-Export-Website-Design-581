      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mt-2 mb-4">
            Fresh Full Carcass 
            <span className="text-blue-600"> Halal Beef</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We specialize exclusively in premium fresh full carcass halal beef, 
            processed with precision and care for international export.
          </p>
        </motion.div>
